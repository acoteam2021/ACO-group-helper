...
var inline = [
  [
    { title: quiz1, command: "/ans2 " + quiz1 },

    { title: quiz2, command: "/ans2 " + quiz2 }
  ],
  [
    { title: quiz3, command: "/ans2 " + quiz3 },

    { title: quiz4, command: "/ans2 " + quiz4 }
  ],
  [
    { title: quiz5, command: "/ans2 " + quiz5 },

    { title: quiz6, command: "/ans2 " + quiz6 }
  ],
  [
    { title: quiz7, command: "/ans2 " + quiz7 },

    { title: quiz8, command: "/ans2 " + quiz8 }
  ],
  [
    { title: quiz9, command: "/ans2 " + quiz9 },

    { title: quiz10, command: "/ans2 " + quiz10 }
  ]
]
